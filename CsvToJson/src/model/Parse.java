...
public class Parse{
	...
	public void Conversao() {
		...
		do {
			String[] tarefa = ControlerQueue.getTarefa();
			if (tarefa != null) {
				...
				ControlerQueue.AddTarefaEscrever(new Gson().toJson(newJson));
			}

		} while (ControlerQueue.Acabou());
		ControlerQueue.setFinalizarConvert(false);
